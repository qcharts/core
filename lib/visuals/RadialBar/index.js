...
var RadialBar = /*#__PURE__*/function (_BaseVisual) {
  ...
  function RadialBar() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(RadialBar).call(this, attrs));
  ...
  _createClass(RadialBar, [{
    ...
    value: function render() {
      ...
      var _this$renderAttrs2 = this.renderAttrs,
          strokeBgcolor = _this$renderAttrs2.strokeBgcolor,
      ...
      return qcharts.h(Group, {
        ...
        })), qcharts.h(Arc, _extends({}, _objectSpread(_objectSpread({}, d), {}, {
          col: col,
          row: row
        }), {
