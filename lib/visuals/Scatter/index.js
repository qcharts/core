...
var Scatter = /*#__PURE__*/function (_BaseVisual) {
  ...
  function Scatter() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Scatter).call(this, attrs));
    _this.type = 'scatter';
    _this.scatterData = [];
    _this.guideLineData = [];
    return _this;
  ...
  _createClass(Scatter, [{
    ...
    value: function processData() {
      ...
      var _layout$call = layout.call(this, dataSet, [clientRect.width, clientRect.height], layoutWay, axisGap),
    ...
    value: function renderScatter(data) {
      ...
      var scatters = data.map(function (item, di) {
        return item.attrs.map(function (attr, ci) {
          var style = _this5.style('point')(attr, _objectSpread({}, attr.dataOrigin), ci);
          ...
          if (labelField) {
            var _style = _this5.style('label')(attr, _objectSpread({}, attr.dataOrigin), ci);
          ...
          return qcharts.h(Group, {
            ...
            zIndex: 9 + di + ci
          })), labelAttr ? qcharts.h(Label, labelAttr) : null);
        });
      });
