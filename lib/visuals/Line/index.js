...
var Line = /*#__PURE__*/function (_Base) {
  ...
  function Line(attrs) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Line).call(this, attrs));
    _this.renderLines = [];
    _this.type = 'line';
    _this.hoverIndex = -1;
    return _this;
  ...
  _createClass(Line, [{
    ...
    value: function beforeUpdate() {
      ...
      var lines = arrLayout.map(function (item, i) {
        ...
        if (!renderLines[i] || renderLines[i].state === 'disabled') {// from.lineDash = [4, maxLen]
        }
    ...
    value: function render(lines) {
      ...
      return qcharts.h(Group, {
        ...
        var style = getStyle(_this2, 'line', [{
          ...
          smooth: smooth
        }, styles.line], [_this2.dataset.rows[ind], ind]); // if (style.lineDash) {
