...
var Radar = /*#__PURE__*/function (_BaseVisual) {
  ...
  function Radar(attrs) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Radar).call(this, attrs));
  ...
  _createClass(Radar, [{
    ...
    value: function processData() {
      ...
      return _objectSpread({}, otherData, {
    ...
    value: function renderAxisScale(attrs, index) {
      ...
      for (var i = 0; i < attrs.splitNumber + 1; i++) {
        ...
        if (attr.display !== 'none') {
          ...
          labels.push(qcharts.h(Label, _extends({}, attr, style, {
            animation: animation
          })));
        }
      }
